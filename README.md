# [concrete5](https://www.concrete5.org) チートシート V8+

これはconcrete5 Ver.8以降の主にPHPのバックエンドのチートシート集です。

**[issues](https://github.com/shahroq/whale_c5_cheat_sheet/issues) や [pull requests](https://github.com/shahroq/whale_c5_cheat_sheet/pulls)などのコントリビュートは大歓迎です。**
...
- [スーパーグローバル変数](#superglobals)
  - [controllerでの$request](#request-in-a-controller)
  - [カスタムクラスでの$request](#request-in-a-custom-class)
  - [その他の場所での$request](#request-in-other-places)
- [ページ (Collections)](#pages-collections)
  - [ページ](#a-page)
    - [現在のページの取得](#get-current-page)
    - [ユニークIDでページの取得](#get-a-page-by-a-unique-identifier)
    - [ページデータの取得](#get-a-page-data)
    - [ページタイプ/ページテンプレートの取得](#get-a-page-typetemplate)
...
- [トピック](#topics)
    - [スキーマ](#schema)
    - [トピックツリーの取得](#get-a-topic-tree)
    - [トピックツリー一覧](#list-of-topic-trees)
    - [トピックツリーの子要素取得 (カテゴリ, ノード)](#get-children-categories-nodes-of-a-topic-tree)
    - [トピックツリー操作](#topic-tree-operations)
    - [カテゴリ/ノードの取得](#get-a-categorynode)
    - [カテゴリ/ノードの追加](#add-a-categorynode)
- [属性](#attributes-3)
...
- [Config](#configs)
  ...
  - [Different places for storing data](#different-places-for-storing-data)
    - [データベース](#database)
    - [ファイル](#filesystem)
  - [その他のConfigの読み書き方法](#different-ways-to-read-and-write-config-values)
    - [1: パッケージオブジェクトの使う](#1-using-a-package-object)
    - [2: サービスプロバイダを使う](#2-using-a-service-provider)
    - [3: Configを使う](#3-using-config)
- [エイリアス](#aliases)
    - [エイリアス一覧](#list-of-all-aliases)
- [ヘルパー](#helpers)
    - [General](#general)
    ...
    - [全てのヘルパー一覧](#list-of-all-helper)
- [システム操作](#system-operations)
  - [データベース](#database-1)
    - [現在のデータベース](#current-database)
    - [他のデータベース](#another-database)
  - [その他](#misc)
    - [URL](#url)
    - [ログ](#logging)
    - [環境変数の取得](#get-environment)
    - [キャッシュクリア](#clear-site-cache)
